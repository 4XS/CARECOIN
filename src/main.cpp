...
uint256 hashGenesisBlock("0x0000000049898413346905aed03f2c4eb39662ef18c1980d20fa863483c6b239");
...
const string strMessageMagic = "CARECOIN Signed Message:\n";
...
static const int64 nTargetSpacing = 60000;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000049898413346905aed03f2c4eb39662ef18c1980d20fa863483c6b239");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1420839335;
        block.nBits    = 486604799;
        block.nNonce   = 1801552686;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CARECOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CARECOINMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running CARECOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CARECOINMiner terminated\n");
        throw;
    }
}
